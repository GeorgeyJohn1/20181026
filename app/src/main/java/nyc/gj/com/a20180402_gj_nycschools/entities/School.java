package nyc.gj.com.a20180402_gj_nycschools.entities;
...
public class School {
    ...
    {
        return "[{bbl : "+bbl+", attendance_rate : "+attendance_rate+"xs , phone_number : "+phone_number+" , total_students : "+total_students+", dbn : "+dbn+", longitude : "+longitude+", state_code : "+state_code+" , latitude : "+latitude+",  boro : "+boro+",  fax_number : "+fax_number+" , zip : "+zip+", school_email : "+school_email+" , website : \""+website+"\", borough : "+borough+"}]";
    }
    //, school_name : "+school_name.replace(","," ").replace("&"," and ")+
}
